...
class JavaClassWrapper {
  ...
  static runProxyMethod(methodObject, argumentsList) {
    console.log(methodObject, argumentsList);
    return new Promise(
      (resolve, reject) => {
        JavaClassWrapper.getClassWrapperByName(methodObject._parent._identifier)
        .then(classWrapper => {
          classWrapper.runClassMethod(methodObject._name, argumentsList)
          .then(
